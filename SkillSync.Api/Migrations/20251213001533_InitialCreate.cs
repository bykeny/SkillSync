        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RelatedSkillIds = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GitHubProfiles_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastCommitDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    RecordedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LanguageBreakdown = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GitHubActivities_GitHubProfiles_GitHubProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Activities_Skills_SkillId",
                        column: x => x.SkillId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Milestones_Skills_SkillId",
                        column: x => x.SkillId,
                        principalTable: "Skills",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProgressHistories_Skills_SkillId",
                        column: x => x.SkillId,
                        principalTable: "Skills",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "ColorHex", "Description", "IconName", "Name" },
                values: new object[,]
                {
                    { 1, "#3B82F6", "Languages like C#, Python, JavaScript", "code", "Programming Languages" },
                    { 2, "#10B981", "Frameworks like .NET, React, Angular", "layers", "Frameworks & Libraries" },
                    { 3, "#F59E0B", "SQL, NoSQL, Cloud Storage", "database", "Database & Storage" },
                    { 4, "#8B5CF6", "CI/CD, Docker, Azure, AWS", "cloud", "DevOps & Cloud" },
                    { 5, "#EC4899", "Communication, Leadership, Problem Solving", "users", "Soft Skills" },
                    { 6, "#6366F1", "Git, Agile, Testing", "settings", "Tools & Practices" }
                });

            migrationBuilder.CreateIndex(
                name: "IX_Activities_SkillId",
                table: "Activities",
                column: "SkillId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GitHubActivities_GitHubProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProgressHistories_SkillId",
